...
# plt.savefig("sub001_run005_TimeSeries.png")
# plt.clf()
# plt.close()

# plt.plot(arr6)
# plt.title("Actual vs Series")
# plt.savefig("sub001_run006_TimeSeries.png")
# plt.clf()
# plt.close()

# plt.plot(arr7)
# plt.title("Actual vs Series")
# plt.savefig("sub001_run007_TimeSeries.png")
# plt.clf()
# plt.close()

# plt.plot(arr8)
# plt.title("Actual vs Series")
# plt.savefig("sub001_run008_TimeSeries.png")
# plt.clf()
# plt.close()

# plt.plot(arr9)
# plt.title("Actual vs Series")
# plt.savefig("sub001_run009_TimeSeries.png")
# plt.clf()
# plt.close()

# plt.plot(arr10)
# plt.title("Actual vs Series")
# plt.savefig("sub001_run010_TimeSeries.png")
# plt.clf()
# plt.close()

# plt.plot(arr11)
# plt.title("Actual vs Series")
# plt.savefig("sub001_run011_TimeSeries.png")
# plt.clf()
# plt.close()

# plt.plot(arr12)
# plt.title("Actual vs Series")
# plt.savefig("sub001_run012_TimeSeries.png")
# plt.clf()
# plt.close()
